...
@push('css')
    ...
    <style>
        .header-bg{
            height: 400px;
            width: 100%;
            background-image: url({{ Storage::disk('s3')->url('post/slider/'.$post->image) }});
                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{ Storage::disk('s3')->url('profile/'.$post->user->image) }}" alt="Profile Image"></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ Storage::disk('s3')->url('post/'.$randompost->image) }}" alt="{{ $randompost->title }}"></div>

                                <a class="avatar" href="#"><img src="{{ Storage::disk('s3')->url('profile/'.$randompost->user->image) }}" alt="Profile Image"></a>
                            ...
                            <div class="commnets-area ">
                                ...
                                <div class="comment">
                                    ...
                                    <div class="post-info">
                                        ...
                                        <div class="left-area">
                                            <a class="avatar" href="#"><img src="{{ Storage::disk('s3')->url('profile/'.$comment->user->image) }}" alt="Profile Image"></a>
                                        </div>
